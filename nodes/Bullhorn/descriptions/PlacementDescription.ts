...
export const placementFields: INodeProperties[] = [
	...
	},
	{
		...
		type: 'string',
		required: true,
		displayOptions: { show: { resource: ['placement'], operation: ['getAll'], searchType: ['query'] } },
		default: 'isDeleted=false',
		description: 'SQL WHERE syntax (e.g. "candidate.id=123 AND status=\'Placed\'")',
	},
	{
		...
		type: 'string',
		required: true,
		displayOptions: { show: { resource: ['placement'], operation: ['getAll'], searchType: ['search'] } },
		default: 'isDeleted:false',
