...
export const clientCorporationFields: INodeProperties[] = [
	...
	},
	{
		...
		type: 'string',
		required: true,
		displayOptions: { show: { resource: ['clientCorporation'], operation: ['getAll'], searchType: ['query'] } },
		default: 'isDeleted=false',
		description: 'SQL WHERE syntax (e.g. "id IN (100,200) AND isDeleted=false")',
	},
	{
		...
		type: 'string',
		required: true,
		displayOptions: { show: { resource: ['clientCorporation'], operation: ['getAll'], searchType: ['search'] } },
		default: 'isDeleted:false',
		description: 'Lucene query syntax (e.g. "name:Acme")',
	},
	{
